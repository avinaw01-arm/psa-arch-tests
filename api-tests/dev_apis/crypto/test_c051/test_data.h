...
typedef struct {
    ...
    psa_status_t            expected_status;
      ...
      defined(ARCH_TEST_CIPHER_MODE_ECB))) || \
...
#ifdef ARCH_TEST_AES_128
{"Test psa_cipher_decrypt - Decrypt - AES-128 ECB (FIPS-197)\n", PSA_KEY_TYPE_AES,
{0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6, 0xab, 0xf7, 0x15, 0x88, 0x09,
 0xcf, 0x4f, 0x3c}, AES_16B_KEY_SIZE,
 PSA_KEY_USAGE_DECRYPT, PSA_ALG_ECB_NO_PADDING,
{0x3a, 0xd7, 0x7b, 0xb4, 0x0d, 0x7a, 0x36, 0x60, 0xa8, 0x9e, 0xca, 0xf3, 0x24,
 0x66, 0xef, 0x97}, 16, SIZE_32B,
{0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73,
 0x93, 0x17, 0x2a}, 16, PSA_SUCCESS
},
#endif
#ifdef ARCH_TEST_AES_192
{"Test psa_cipher_decrypt - Decrypt - AES-192 ECB (FIPS-197)\n", PSA_KEY_TYPE_AES,
{0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80,
 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b}, AES_24B_KEY_SIZE,
 PSA_KEY_USAGE_DECRYPT, PSA_ALG_ECB_NO_PADDING,
{0xbd, 0x33, 0x4f, 0x1d, 0x6e, 0x45, 0xf2, 0x5f, 0xf7, 0x12, 0xa2, 0x14, 0x57,
 0x1f, 0xa5, 0xcc}, 16, SIZE_32B,
{0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73,
 0x93, 0x17, 0x2a}, 16, PSA_SUCCESS
},
#endif
#ifdef ARCH_TEST_AES_256
{"Test psa_cipher_decrypt - Decrypt - AES-256 ECB (FIPS-197)\n", PSA_KEY_TYPE_AES,
{0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85,
 ...
 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4}, AES_32B_KEY_SIZE,
 PSA_KEY_USAGE_DECRYPT, PSA_ALG_ECB_NO_PADDING,
{0xf3, 0xee, 0xd1, 0xbd, 0xb5, 0xd2, 0xa0, 0x3c, 0x06, 0x4b, 0x5a, 0x7e, 0x3d,
 0xb1, 0x81, 0xf8}, 16, SIZE_32B,
{0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73,
 0x93, 0x17, 0x2a}, 16, PSA_SUCCESS
},
#endif
...
{"Test psa_cipher_decrypt - Decrypt - AES ARIA\n", PSA_KEY_TYPE_ARIA,
{0x00, 0x01, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c,
0x0d, 0x0e, 0x0f}, AES_16B_KEY_SIZE, PSA_KEY_USAGE_DECRYPT|PSA_KEY_USAGE_ENCRYPT,
PSA_ALG_CBC_NO_PADDING, {0xF3, 0xA1, 0x50, 0x19, 0x5A, 0xDE, 0x05, 0x54, 0x9D, 0x9B,
0xCB, 0x91, 0xC2, 0x85, 0x24, 0x5C, 0x2B, 0x84, 0x5D, 0xE3, 0xD8, 0xE2, 0xB6, 0x90,
0x21, 0x15, 0xA7, 0xFD, 0x85, 0x15, 0x72, 0x18}, 32, SIZE_32B, {0x00, 0x11, 0x22,
0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff}, 16, PSA_SUCCESS
},
#endif
