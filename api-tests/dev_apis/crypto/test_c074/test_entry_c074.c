...
#define TEST_NUM  VAL_CREATE_TEST_ID(VAL_CRYPTO_BASE, 74)
#define TEST_DESC "psa_pake_output : Desc=crypto PAKE APIs : "
...
void test_entry(val_api_t *val_api, psa_api_t *psa_api)
{
    ...
    status = val->execute_non_secure_tests(TEST_NUM, test_c074_crypto_list, FALSE);
