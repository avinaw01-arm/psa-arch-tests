...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Insufficient space check : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Insufficient space check : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Insufficient space check : "
#endif
