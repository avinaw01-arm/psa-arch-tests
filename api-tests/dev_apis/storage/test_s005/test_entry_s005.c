...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Success scenarios check : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Success scenarios check : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Success scenarios check : "
#endif
