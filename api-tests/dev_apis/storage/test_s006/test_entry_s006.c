...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Check for storage create flags : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Check for storage create flags : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Check for storage create flags : "
#endif
