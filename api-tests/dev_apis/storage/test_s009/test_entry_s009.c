...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Invalid Arguments check : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Invalid Arguments check : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Invalid Arguments check : "
#endif
