...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Optional APIs - Invalid arguments and offset invalid : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Optional APIs - Invalid arguments and offset invalid : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Optional APIs - Invalid arguments and offset invalid : "
#endif
