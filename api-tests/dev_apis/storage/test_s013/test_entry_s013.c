...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Set_Extended and Create api - Success : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Set_Extended and Create api - Success : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Set_Extended and Create api - Success : "
#endif
