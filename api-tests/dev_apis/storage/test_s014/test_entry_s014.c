...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Optional APIs not supported check : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Optional APIs not supported check : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Optional APIs not supported check : "
#endif
