...
#if defined(STORAGE)
    #define TEST_DESC "STORAGE : Desc=Storage assest capacity modification check : "
#elif defined(INTERNAL_TRUSTED_STORAGE)
    #define TEST_DESC "ITS : Desc=Storage assest capacity modification check : "
#elif defined(PROTECTED_STORAGE)
    #define TEST_DESC "PS : Desc=Storage assest capacity modification check : "
#endif
