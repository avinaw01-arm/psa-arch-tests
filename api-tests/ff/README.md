...
```
-   -DNO_FSHORT_FLAGS=<0|1> : This option is applicable only for ARMCLANG toolchain. 0 means compile with `-fshort-enums` and `-fshort-wchar`, and 1 means compile without these flags. Default is 0.
